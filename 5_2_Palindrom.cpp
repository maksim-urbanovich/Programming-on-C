/* Условие задачи
	Палиндром. С помощью двунаправленного списка определите, является ли строка палиндромом
(т.е. одинаково читается справа налево и слева направо). Пробелы и знаки пунктуации - игнорируйте.
*/
