/* Условие задачи:
	Супермаркет. С помощью динамической структуры Очередь промоделируйте очередь в
кассу супермаркета. Покупатели подходят к кассе через n (случайное целое число от 1 до 4) секунд. 
на обслуживание каждого покупателя тратится m (случайное целое число от 1 до 4) секунд. 
Запустите вашу модель на минуту. 
Вывести на экран:
· максимальное количество покупателей, которые оказались в очереди;
· максимальное время, которое покупателю пришлось ждать в очереди.
Представьте очередь в графическом виде.
*/
